...
**分析时间**: 2026-04-16T01:44:46.326371
...
- 🎮 **Controller**: `OrderController`
  - 文件：`/workspace/demo-backend/src/main/java/com/example/demo/controller/OrderController.java`
- ⚙️ **Service**: `OrderServiceImpl`
  - 文件：`/workspace/demo-backend/src/main/java/com/example/demo/service/OrderServiceImpl.java`
- 🗂️ **Mapper**: `OrderMapper`
  - 文件：`/workspace/demo-backend/src/main/java/com/example/demo/mapper/OrderMapper.java`
...
- 🎮 **Controller**: `UserController`
  - 文件：`/workspace/demo-backend/src/main/java/com/example/demo/controller/UserController.java`
- ⚙️ **Service**: `UserServiceImpl`
  - 文件：`/workspace/demo-backend/src/main/java/com/example/demo/service/UserServiceImpl.java`
- 🗂️ **Mapper**: `UserMapper`
  - 文件：`/workspace/demo-backend/src/main/java/com/example/demo/mapper/UserMapper.java`
